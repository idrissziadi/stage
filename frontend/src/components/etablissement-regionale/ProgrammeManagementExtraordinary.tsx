    ...
    <div className="space-y-6" dir="rtl">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full" dir="rtl">
        <TabsList className="grid w-full grid-cols-2 bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl p-1 h-14">
          <TabsTrigger 
            value="create" 
            className="rounded-xl text-lg font-medium data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-600 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300 flex items-center gap-2 font-arabic"
          >
          ...
          <TabsTrigger 
            value="list"
            className="rounded-xl text-lg font-medium data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-600 data-[state=active]:to-blue-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300 flex items-center gap-2 font-arabic"
          >
