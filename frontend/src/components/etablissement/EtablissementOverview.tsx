  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-gray-600 dark:text-gray-400 font-arabic">جارٍ تحميل نظرة عامة...</p>
      </div>
    );
  }
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="text-start-rtl">
                <p className="text-sm font-medium text-blue-600 dark:text-blue-400 font-arabic">الأساتذة</p>
        ...
        <Card className="border-l-4 border-l-green-500 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-s-rtl">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="text-start-rtl">
                <p className="text-sm font-medium text-green-600 dark:text-green-400 font-arabic">المتدربين</p>
        ...
        <Card className="border-l-4 border-l-purple-500 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-s-rtl">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="text-start-rtl">
                <p className="text-sm font-medium text-purple-600 dark:text-purple-400 font-arabic">عروض التكوين</p>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-arabic">رمز المؤسسة</p>
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 font-arabic">اسم المؤسسة</p>
                  <div className="flex items-center gap-2">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-start-rtl">
                    ...
                    <p className="text-sm text-gray-600 font-arabic">إضافة وإدارة الأساتذة والمتدربين</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-start-rtl">
                    ...
                    <p className="text-sm text-gray-600 font-arabic">إنشاء وتعديل عروض التكوين</p>
                  </div>
                </div>
                <ArrowRight className="w-4 h-4" />
              </Button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-start-rtl">
                    ...
                    <p className="text-sm text-gray-600 font-arabic">تخصيص ومتابعة المذكرات</p>
                  </div>
                </div>
                <ArrowRight className="w-4 h-4" />
              </Button>
        ...
        <CardContent>
          {stats.recentActivities.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2 font-arabic">لا توجد نشاطات حديثة</h3>
              ...
              {stats.recentActivities.map((activity, index) => (
                <div key={index} className="flex items-start gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-900 font-arabic">{activity.title}</h4>
                    <p className="text-sm text-gray-600 font-arabic">{activity.description}</p>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="bg-green-50 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-green-600 font-arabic">إجمالي التسجيلات المقبولة</p>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-blue-600 font-arabic">عروض التكوين النشطة</p>
            </div>
          </div>
        </CardContent>
      </Card>
