        ...
        <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
          <AlertDialogContent className="max-w-sm border-l-4 border-l-destructive bg-gradient-to-br from-red-50 via-pink-50 to-red-100 dark:from-red-950/30 dark:via-pink-950/20 dark:to-red-950/30 shadow-2xl">
            <AlertDialogHeader className="text-center">
              ...
              <AlertDialogTitle className="text-lg font-bold text-foreground dark:text-white font-arabic">
                تأكيد تسجيل الخروج
              </AlertDialogTitle>
              <AlertDialogDescription className="text-muted-foreground dark:text-muted-foreground font-arabic text-sm">
                هل أنت متأكد من تسجيل الخروج؟
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter className="flex gap-2 pt-4">
              <AlertDialogCancel 
                className="font-arabic flex-1 hover:bg-muted dark:hover:bg-gray-800 transition-all duration-200 px-4 py-2 rounded-lg border-border-medium dark:border-gray-600"
              >
                إلغاء
              </AlertDialogCancel>
              <AlertDialogAction 
    ...
    return (
      <>
        <Button
          ...
          variant="ghost"
          size="sm"
          className={`hover:bg-red-50 dark:hover:bg-red-950/20 hover:text-error dark:hover:text-red-400 transition-all duration-200 ${className}`}
        >
          <LogOut className="w-4 h-4 ml-1" />
          خروج
        </Button>
        ...
        <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
          <AlertDialogContent className="max-w-sm border-l-4 border-l-destructive bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950/20 dark:to-pink-950/20">
            <AlertDialogHeader className="text-center">
              ...
              <AlertDialogTitle className="text-base font-bold text-foreground dark:text-white font-arabic">
                تسجيل الخروج
              </AlertDialogTitle>
              <AlertDialogDescription className="text-muted-foreground dark:text-muted-foreground font-arabic text-sm">
            ...
            <AlertDialogFooter className="flex gap-2 pt-3">
              <AlertDialogCancel 
                className="font-arabic flex-1 text-sm hover:bg-muted dark:hover:bg-gray-800 transition-colors duration-200 px-3 py-1.5 rounded-md"
              >
                إلغاء
              </AlertDialogCancel>
              <AlertDialogAction 
