// models/EtablissementRegionale.js
const { DataTypes } = require('sequelize');
const { sequelize } = require('../config/database');

const EtablissementRegionale = sequelize.define('EtablissementRegionale', {
  id_etab_regionale: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true,
    comment: 'Identifiant unique de l\'établissement régional'
  },
  code: {
    type: DataTypes.STRING(50),
    unique: {
      name: 'unique_code_etab_regionale',
      msg: 'Ce code d\'établissement régional existe déjà'
    },
    allowNull: false,
    validate: {
      notEmpty: {
    ...
    comment: 'Code unique de l\'établissement régional'
  },
  nom_fr: {
  ...
  tableName: 'EtablissementRegionale',
  timestamps: true,
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  indexes: [
...
module.exports = EtablissementRegionale;