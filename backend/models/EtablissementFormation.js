// models/EtablissementFormation.js
const { DataTypes } = require('sequelize');
const { sequelize } = require('../config/database');

const EtablissementFormation = sequelize.define('EtablissementFormation', {
  id_etab_formation: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true,
    comment: 'Identifiant unique de l\'établissement de formation'
  },
  code: {
    type: DataTypes.STRING(50),
    unique: {
      name: 'unique_code_etab_formation',
      msg: 'Ce code d\'établissement de formation existe déjà'
    },
    allowNull: false,
    validate: {
      notEmpty: {
    ...
    comment: 'Code unique de l\'établissement de formation'
  },
  nom_fr: {
  ...
  tableName: 'EtablissementFormation',
  timestamps: true,
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  indexes: [
...
module.exports = EtablissementFormation;